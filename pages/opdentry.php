                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="dashboard-box dashboard-box-chart bg-white content-box"> 
                            ...
                            <br>
                            <form action="opd_entry.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="guardian" placeholder="Guardian (if any)">
                                    </div> 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="radio" class=" radio-inline" name="gender" value="Male" checked> Male
                                        <input type="radio" class=" radio-inline" name="gender" value="Female"> Female
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Other Information</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="info" placeholder="Other Information" >
                                    </div> 
                                </div>

                                <div class="form-group">
                                    <button class="btn btn-alt btn-hover btn-primary" name="opd_entry">
