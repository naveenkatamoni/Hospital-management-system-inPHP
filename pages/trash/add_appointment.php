                            ...
                            <?php 
                                ...
                                if(isset($_POST['add_appointment'])){ 
                                    ...
                                    $t_charges = $_POST['t_charges'];
                                     ...
                                     $query="INSERT INTO add_appointment (`patient_id`, `p_name`, `checkup`, `collected`,  `date`, `charges`, `ocharges`, `t_charges`) values('".$patient_id."', '".$p_name."', '".$checkup."', '".$collected."', '".$date."', '".$charges."', '".$ocharges."', '".$t_charges."')";
